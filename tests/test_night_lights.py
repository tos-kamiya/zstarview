...
def test_akari_midnight_opacity_uses_absolute_default_range() -> None:
    assert night_lights.akari_midnight_opacity(0.10, 1.0) == pytest.approx(0.10)
    assert night_lights.akari_midnight_opacity(0.10, 0.5) == pytest.approx(0.10)
...
def test_akari_midnight_opacity_scales_custom_base_opacity() -> None:
    assert night_lights.akari_midnight_opacity(0.30, 1.0) == pytest.approx(0.30)
