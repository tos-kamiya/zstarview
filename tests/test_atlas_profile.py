...
def test_atlas_profile_preserves_explicit_cli_options() -> None:
    args = parse_args(
        [
            "--theme",
            "night",
...
def test_atlas_parser_uses_atlas_vmag_defaults_and_maximum() -> None:
    args = parse_args(
        [],
...
def test_atlas_parser_rejects_scenic_only_options(option: str) -> None:
