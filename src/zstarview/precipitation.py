...
PRECIPITATION_NEAR_STREAK_HEIGHT_DEG = 7.0
PRECIPITATION_FAR_STREAK_HEIGHT_DEG = 1.6
PRECIPITATION_NEAR_OPACITY_FACTOR = 1.0
PRECIPITATION_FAR_OPACITY_FACTOR = 0.35
PRECIPITATION_MAX_STREAK_COUNT = 6
PRECIPITATION_TILE_LINE_WIDTH = 0.45
PRECIPITATION_TILE_LINE_WIDTH_RATIO = 0.08
