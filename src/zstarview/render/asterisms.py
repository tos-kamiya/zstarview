...
def draw_asterisms(
    ...
    *,
    ...
    if draw_base:
        base_outline_pen = _make_pen(base_outline_color, 3.2 * width_scale)
        base_line_pen = _make_pen(base_line_color, 2.0 * width_scale)
    ...
    if highlighted_asterism is not None:
        highlight_outline_pen = _make_pen(highlight_outline_color, 2.56 * width_scale)
        highlight_line_pen = _make_pen(highlight_line_color, 1.6 * width_scale)
