...
NIGHT_LIGHTS_MID_ALPHA_SCALE = 0.08
NIGHT_LIGHTS_OUTER_ALPHA_SCALE = 0.02
NIGHT_LIGHTS_MIN_BRIGHTNESS = 0.02
NIGHT_LIGHTS_GLOW_RGB = (244, 246, 248)
NIGHT_LIGHTS_DRAW_AZIMUTH_STEP_DEG = 0.5
NIGHT_LIGHTS_OUTER_WIDTH_SCALE = 5.4
NIGHT_LIGHTS_MID_WIDTH_SCALE = 2.4
NIGHT_LIGHTS_CORE_WIDTH_SCALE = 0.6
    ...
    for layer_index, layer_altaz in enumerate(layer_altaz_sets):
        ...
        for fragment in split_by_gaps(projected_points):
            ...
            for alpha_scale, width_scale in (
                ...
                (NIGHT_LIGHTS_MID_ALPHA_SCALE, NIGHT_LIGHTS_MID_WIDTH_SCALE),
