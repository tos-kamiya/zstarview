...
class SkyWindowRenderMixin:
    ...
    def _render_frame_cache_key(
        ...
        *,
        ...
        key_parts: list[object] = [
            ...
            round(float(getattr(self, "water_overlay_opacity", 0.28)), 3),
            bool(self.show_urban_outline_layer),
            bool(getattr(self, "show_water_overlay_layer", True)),
            self._render_cache_stamp(self.state.water_surfaces),
    ...
    def _render_scene_data(
        ...
        *,
        ...
        return RenderSceneData(
            ...
            water_surfaces=getattr(state, "water_surfaces", None),
    ...
    def _render_style(self) -> RenderStyle:
        ...
        return RenderStyle(
            ...
            show_water_overlay_layer=bool(getattr(self, "show_water_overlay_layer", True)),
            water_overlay_opacity=float(getattr(self, "water_overlay_opacity", 0.28)),
