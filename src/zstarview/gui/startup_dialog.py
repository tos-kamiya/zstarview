...
class StartupDialog(QDialog):
    ...
    def _add_specs(self) -> None:
        specs = (
            _FieldSpec("city", "City", "text", "Observing Location and Time"),
            _FieldSpec("place", "Place query", "text", "Observing Location and Time"),
            _FieldSpec(
                "place_countrycode",
                "Place country code",
                "text",
            ...
            _FieldSpec("place_lang", "Place language", "text", "Observing Location and Time"),
            _FieldSpec("hours", "Hours", "float", "Observing Location and Time", minimum=-9999.0, maximum=9999.0, step=0.5),
            _FieldSpec("days", "Days", "float", "Observing Location and Time", minimum=-9999.0, maximum=9999.0, step=0.5),
            _FieldSpec("datetime", "Date/time", "text", "Observing Location and Time"),
            _FieldSpec("timezone", "Timezone", "text", "Observing Location and Time"),
            _FieldSpec("view_center_alt", "View center alt", "float", "Observing Location and Time", minimum=-90.0, maximum=90.0, step=1.0),
            _FieldSpec("view_center_az", "View center az", "float", "Observing Location and Time", minimum=0.0, maximum=360.0, step=1.0),
            _FieldSpec("edge_fov_deg", "Edge FOV", "float", "Observing Location and Time", minimum=0.1, maximum=135.0, step=0.5),
            _FieldSpec("content_fov_deg", "Content FOV", "float", "Observing Location and Time", minimum=90.0, maximum=135.0, step=0.5),
            _FieldSpec("observer_height_m", "Observer height", "float", "Observing Location and Time", minimum=0.0, maximum=10000.0, step=0.1),
            _FieldSpec("use_building_top", "Use building top", "bool", "Observing Location and Time"),
            ...
            _FieldSpec("vmag_limit", "Vmag limit", "float", "Sky and Stars", minimum=0.0, maximum=20.0, step=0.1),
            _FieldSpec("vmag_brightness_multiplier", "Brightness multiplier", "float", "Sky and Stars", minimum=1.0, maximum=3.0, step=0.01),
            _FieldSpec("enlarge_moon", "Enlarge moon", "bool", "Sky and Stars"),
            _FieldSpec("bright_bodies", "Bright bodies", "choice", "Sky and Stars", choices=("outline", "fill")),
            _FieldSpec("star_base_radius", "Star base radius", "float", "Sky and Stars", minimum=0.0, maximum=20.0, step=0.1),
            _FieldSpec("expected_render_width", "Expected render width", "int", "Sky and Stars", minimum=1.0, maximum=10000.0, step=1.0),
            _FieldSpec("sky_opacity", "Sky opacity", "float", "Sky and Stars", minimum=0.0, maximum=1.0, step=0.01),
            _FieldSpec("sky_disc_style", "Sky disc style", "choice", "Sky and Stars", choices=("smooth",)),
            _FieldSpec("sky_disc_altaz_rings", "Sky disc rings", "choice", "Sky and Stars", choices=("off", "dimalt", "altaz")),
            _FieldSpec("sky_disc_altaz_rings_hover", "Hover rings", "choice", "Sky and Stars", choices=("off", "dimalt", "altaz")),
            _FieldSpec("show_dso_initial", "DSO visibility", "choice", "Sky and Stars", choices=("default", "true", "false")),
            _FieldSpec("show_asterisms_initial", "Asterisms visibility", "choice", "Sky and Stars", choices=("default", "true", "false")),
            _FieldSpec("show_guidelines_initial", "Guidelines visibility", "choice", "Sky and Stars", choices=("default", "true", "false")),
