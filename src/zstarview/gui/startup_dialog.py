...
class StartupDialog(QDialog):
    ...
    def _add_specs(self) -> None:
        specs = (
            ...
            _FieldSpec("moon_style", "Moon style", "choice", "Celestial", choices=("marker", "sphere", "image")),
            _FieldSpec("moon_scale", "Moon scale", "int", "Celestial", minimum=1.0, maximum=8.0, step=1.0),
            ...
            _FieldSpec("akari_ir_bands_opacity", "Diffuse sky opacity", "float", "Celestial", minimum=0.0, maximum=1.0, step=0.01),
