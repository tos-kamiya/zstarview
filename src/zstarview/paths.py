...
GMN_METEOR_CACHE_ROOT_DIR = os.path.join(CACHE_PATH, "meteors", "gmn", "schema-1")
...
CLOUD_DEFAULT_OPACITY = 0.07
NIGHT_LIGHT_DEFAULT_OPACITY = 0.22
ROAD_LIGHT_DEFAULT_OPACITY = 0.12
RIDGE_GLOW_DEFAULT_OPACITY = 0.08
...
URBAN_OUTLINE_LAYER_LINE_COLOR = (207, 229, 255)
