...
def add_sky_and_star_arguments(
    ...
    *,
    ...
    include_twinkle_argument: bool = True,
) -> None:
    ...
    if include_twinkle_argument:
        parser.add_argument(
            ...
            default=30,
            help=(
                "Number of twinkle candidates selected per 2-second update "
                "(default: 30; 0 disables the effect)."
            ),
        )
