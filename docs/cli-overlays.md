...
| `--ridge-glow-opacity OPACITY` | Opacity of the ridge glow drawn over the terrain horizon (0.0–1.0). Use 0.0 to disable the ridge glow independently of the street-light layer. | `0.2` |
