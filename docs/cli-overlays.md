...
| `--night-light-opacity OPACITY` | Opacity of the street-light portion of the NASA night lights overlay (0.0–1.0). Use 0.0 to disable the on-demand Black Marble download and street-light drawing for that run. | `0.12` |
...
| `--ridge-glow-opacity OPACITY` | Opacity of the ridge glow drawn over the terrain horizon (0.0–1.0). Use 0.0 to disable the ridge glow independently of the street-light layer. | `0.5` |
