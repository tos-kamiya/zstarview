...
| `--sky-glow-opacity OPACITY` | Opacity of the sky glow drawn over the terrain horizon (0.0–1.0). Use 0.0 to disable the sky glow independently of the street-light layer. | `0.04` |
