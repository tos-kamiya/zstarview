...
| :----- | :---------- | :------ |
| `-S`, `--sky-opacity SKY_OPACITY` | Overall intensity of the simulated sky-color disc (0.0–1.0). Higher values favor luminance over proportional saturation growth. Use 0.0 to disable the disc and its bright-body contrast underlay. | `0.25` |
...
| `-c`, `--cloud-opacity CLOUD_OPACITY` | Opacity of cloud rendering (0.0–1.0). Use 0.0 to disable for the session, even when `--geo-satellite true` is enabled. At night, the effective opacity is smoothly raised by up to 30% according to solar altitude to keep clouds visible. \*2 | `0.11` |
