...
object viewer は黒の細い実線を使い、通常版の色付き・破線を使うガイドとは別の視認性設定にする。
...
1. 完全白背景
2. 地形地平線、都市アウトライン、水面、Earth guide
3. 雲
4. 恒星アウトライン
5. 恒星本体
6. 太陽、月、惑星
...
5. 白背景向け雲色を調整する。完了。
6. `ThemeStyle` から参照するレイヤースタイルを追加し、航空機、人工衛星、地理補助レイヤーの白背景向け配色と図形アウトラインを整理する。未実施。
