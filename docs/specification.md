...
- マウス左ボタンの押下は、通常表示からはラベルなし簡易表示へ、ラベルなし簡易表示またはラベル付き簡易表示からは通常表示へ、一時的に切り替える扱いとしてよい。
...
- 簡易表示（ラベル付き）と簡易表示（ラベルなし）のどちらの状態でも、マウス左ボタンの押下中は通常状態へ一時的に戻してよい。
- 通常状態でのマウス左ボタン押下中は、従来どおり一時的な簡易表示へ入ってよい。
