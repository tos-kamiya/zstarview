...
| `--edge-fov-deg DEGREES`                    | Projection scale for the window edge. `96` means the window edge corresponds to `96°` from the view center. | `96`    |
...
| `earth_guide_land_110m.json`                                   | Simplified land polygons for the below-horizon earth guide, derived from Natural Earth 1:110m land polygons | [Natural Earth](https://www.naturalearthdata.com/) | [Public domain](https://www.naturalearthdata.com/about/terms-of-use/) |
...
* Earth-guide land polygons are derived from Natural Earth 1:110m land polygons. Natural Earth treats the data as public domain; credit is optional, but we note the source here.
