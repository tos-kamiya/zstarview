...
- **Artificial satellite overlay**: ISS, CSS (Tianhe), and Starlink satellites can be drawn as small purple cross markers between the planet and aircraft layers.
...
| Runtime artificial satellite overlay data fetched from CelesTrak | Orbital-element data used for the optional ISS/CSS (Tianhe)/Starlink overlay | [CelesTrak](https://celestrak.org/) | Not explicitly stated on the source site; see [celestrak.org](https://celestrak.org/) |
