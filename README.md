...
| Runtime water-surface overlay data fetched via Overpass API | Water-surface points derived from OpenStreetMap water features for the optional water layer | [OpenStreetMap](https://www.openstreetmap.org/), [Overpass API](https://overpass-api.de/) | [ODbL 1.0](https://opendatacommons.org/licenses/odbl/) |
