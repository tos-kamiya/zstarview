...
* Urban outline source data are derived from MLIT's **PLATEAU Open Data** 3D city models for Tokyo 23 wards, Nagoya, Kyoto, and Osaka, then reduced into bundled derived building tiles for runtime use.
