...
- **天球ガイド**: 昇らない領域を、天の赤道と同じ見た目のガイド線風の実線円として表示し、地平線まわりの方位ラベル、天頂マーカー、天の極マーカーも重ねて表示します。
...
* **Guidelines**: 幾何学的地平線、天の赤道、黄道、暖色系の実線 never-rises 円、方位ラベル、天頂マーカー、天の極マーカーの表示/非表示を切り替えます。天の赤道とは別色です。
